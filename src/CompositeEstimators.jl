...
"""
function CompositeEstimator(::Type{DensityEstimator}, points, weights; maxPoints::Int=1_000_000, padding::Float64=0.1)
...
function CompositeEstimator(::Type{DensityEstimator}, points; maxPoints::Int=1_000_000, padding::Float64=0.1)
...
"""
    CompositeEstimator(::Type{VelocityEstimator}, points, velocities; maxPoints=1_000_000, padding=0.1)

Build a multi-level composite VelocityEstimator from an extremely large point cloud.
"""
function CompositeEstimator(::Type{VelocityEstimator}, points, velocities; maxPoints::Int=1_000_000, padding::Float64=0.1)
...
# Recursive builder for BVH. Properties are specific for estimator type - weights for DensityEstimator, velocities for VelocityEstimator
